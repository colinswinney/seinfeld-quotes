const Quotes = [
    ...
    {
      quote:
        '"Maybe he\'s an enigma, a mystery wrapped in a riddle." "He\'s a mystery wrapped in a Twinkie."',
      author: "Jerry",
      season: "6",
      episode: "2",
      image: ""
    ...
    {
      quote:
        '"I\'m better with the mothers than I am with the daughters." "Maybe you should date the mothers." "If I could talk to the mothers and have sex with the daughters, then I\'d really have something going."',
    ...
    {
      quote:
        '"Pull the old switcheroo." "I think that\'s \'What\'s good for the goose is good for the gander.\'" "What the hell is a gander anyway?" "It\'s a goose that\'s had the old switcheroo pulled on her."',
